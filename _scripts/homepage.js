/* global $ StripeCheckout ga releaseTitle releaseVersion stripeKey StripeCheckout downloadRegion */

import script from 'scriptjs'

import Slider from './slider'

script('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js', 'jquery')
script('https://checkout.stripe.com/checkout.js?data-alipay=auto&data-locale=auto', 'stripe')

script.ready('jquery', () => {
    script('/scripts/jQuery.leanModal2.js', 'modal')
})

script.ready(['jquery', 'modal', 'stripe'], () => {
    $(function () {
